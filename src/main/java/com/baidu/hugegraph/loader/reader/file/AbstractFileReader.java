...
public abstract class AbstractFileReader implements InputReader {
    ...
    public boolean hasNext() {
        if (this.nextLine == null) {
            String rawLine = this.fetch();
            if (rawLine != null) {
                this.nextLine = this.parser.parse(rawLine);
            } else {
                this.nextLine = null;
            }
        }
    ...
    private LineReader createLineReader(FileSource source) throws Exception {
        ...
        try {
            fis = this.openInputStream(source);
    ...
    protected abstract InputStream openInputStream(FileSource source)
                                                   throws IOException;
}
